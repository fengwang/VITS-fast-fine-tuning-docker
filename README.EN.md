...
Command to build up the docker image and run it
```bash
 docker build --file ./Dockerfile . -t vits  && docker run --rm -it --gpus all --shm-size=16g -v /home/feng/private/workspace/vits_data/vits_input_example_1/yqt/audios-tiny:/input -v /home/feng/private/workspace/vits_data/output.2024.03.02:/output vits sh /workspace/VITS-fast-fine-tuning/scripts/run.sh
```
